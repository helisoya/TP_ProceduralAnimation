...
struct RenderEngine {
	...
	ShaderProgram3D_Skinning shader3D_Skinning;
...
struct RenderParams {
	...
	Render3DCallback* render3DSkinningCallback;
	void* pRender3DSkinningCallbackUserData;
	...
	void* pSkinningVertShaderData;
	unsigned int SkinningVertShaderDataSize;
};
